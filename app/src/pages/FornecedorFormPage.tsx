  ...
  if (id && !existente) {
    return (
      <div className="container">
        <PageHeader breadcrumb={[{ label: "Painel", to: "/painel" }, { label: "Catálogo", to: "/catalogo" }, { label: "Fornecedores", to: "/catalogo/fornecedores" }, { label: "Não encontrado" }]} title="Fornecedor não encontrado" />
      </div>
    );
  }
